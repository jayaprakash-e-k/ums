...
<body class="d-flex justify-content-center align-items-center">
    ...
    <form class="bg-white p-3 rounded-4" action="backend/register.php" method="post" style="width: min(500px, 90%);">
        <h2 class="my-2">Sign Up</h2>
        <div class="mb-3">
        ...
        <a href="loginForm.php" class="d-block m-2">Already a user?</a>
